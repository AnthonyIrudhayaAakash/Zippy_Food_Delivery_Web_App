...
import { emptyCartItems } from "../configs/cartSlice";
import Menu from "./Menu";


const Cart = () => {
    const clearCartStatus = useState(false);
...
return ( 
  <>
    <div className={`menu-filter-btn-div w-24 px-3 py-2 rounded-lg flex items-center transition hover:scale-90 transform ${clearCartStatus ? 'bg-white text-orange-500 border-2 border-orange-500' : 'bg-orange-500 text-white'}`}>
